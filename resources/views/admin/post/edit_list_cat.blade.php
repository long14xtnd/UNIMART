                ...
                <div class="card-body">
                    <form action="{{ route('PostCategory.update',$PostCategory->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ $PostCategory->name }}">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="slug" id="slug" value="{{ $PostCategory->slug }}">
                            @error('slug')
                            <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>

            ...
            <table class="table table-striped table-checkall">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <th scope="row">{{ $t }}</th>
                        <td><img src="{{ url($product->product_thumb) }}" style="width:80px;height:80px" alt=""></td>
                        <td><p class="limited-text">{{ $product->product_title }}</p></td>
                        ...
                        <td>
                            ...
                            @if ($option!='delete')
                            <a href="{{ route('product.delete',$product->id) }}" onclick="return confirm('Bạn có chắc muốn xóa bản ghi này')" class="btn btn-danger btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a>
                            {{-- @else
                            <a href="{{ route('product.forceDelete',$product->id) }}" onclick="return confirm('Xóa vĩnh viễn bản ghi này')" class="btn btn-danger btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a> --}}
                            @endif

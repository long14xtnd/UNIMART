...
<head>
    ...
    {{-- Tiny  --}}
    <script src="https://cdn.tiny.cloud/1/dv4006cfy9zpgf4ydtsa7f3214c61uh0z31korsm33q18pnf/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>

    <script>
    var editor_config = {
        height: 350,
    path_absolute : "http://localhost/UNITEST/",
    selector: 'textarea',
    relative_urls: false,
    plugins: [
                ...
                <ul id="sidebar-menu">
                    ...
                    <li class="nav-link {{ $module_active=='product'?'active':'' }}">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="{{ url('admin/product/color/list') }}">Danh sách màu</a></li>
